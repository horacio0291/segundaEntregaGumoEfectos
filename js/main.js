...
class Pedales{
  constructor(id,nombre, imagen, precio, efecto, seccion){
    this.nombre = nombre;
    this.imagen = imagen;
    this.precio = precio;
    this.efecto = efecto;
...
const nautilus = new Pedales("1","Nautilus", "../assets/nautilus.webp", 18000, "Delay y Chorus","./nautilus.html");
const lighthouse = new Pedales("2","Lighthouse", "../assets/lighthouse.webp", 18000, "Phaser analógico","./lighthouse.html");
const andromeda = new Pedales("3","Andromeda", "../assets/andromeda.webp", 20000, "Reverb digital","./andromeda.html");
const apocalipsis = new Pedales("4","Apocalipsis", "../assets/apocalipsis.webp", 20000, "Overdrive","./apocalipsis.html");
const fuzzilla = new Pedales("5","Fuzzilla", "../assets/fuzzilla.webp", 20000, "Distorsion","./fuzzila.html");
